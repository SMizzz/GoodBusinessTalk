...
//    print(UserDefaults.standard.string(forKey: "token")!)
    if UserDefaults.standard.string(forKey: "token") != nil {
      initialVC = storyboard.instantiateViewController(withIdentifier: R.controller.MAINVC)
    } else {
      initialVC = storyboard.instantiateViewController(withIdentifier: R.controller.LOGINVC)
    }
